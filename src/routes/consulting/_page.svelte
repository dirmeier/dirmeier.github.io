	...
	<div class="columns" style="margin-top: 3%;">
		<div class="column is-11">
			...
			<ul>
				...
				<li>
					implementation of computational pipelines (e.g., of analysis workflows for reproducible
					research)
				</li>
			</ul>
			(*) via, e.g, Stan, NumPyro or TensorFlow Probability (in Python, Julia or C++)<br />
			To find a sketch of topics that I have expertise with, please have a look at my
			<a href="/case-studies">case studies</a> and <a href="/code">code</a>.
		</div>
	</div>
</div>
