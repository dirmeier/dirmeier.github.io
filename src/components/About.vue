<template>
  <div>
    ...
    <p>
      ...
      distributions) without users needing to manually implement samplers or optimizers.
       In that line of research, I frequently contribute to
      ...
      and scientific discovery, and since it mathematically formalizes how (and if) cause-and-effect relationships
      can be established (CI concerns itself with the discovery and inference of cause-and-effect
      relationships).
    </p>
    <p>
      I interact with computers mainly via Python, R and C++, but recently also
      have begun developing in Clojure and Julia. For ML, my tech stack consists of Stan, Jax, NumPyro and TensorFlow (Probability). I am
      ...
      Other than that, I have some experience with high-performance and cloud computing, e.g., via
