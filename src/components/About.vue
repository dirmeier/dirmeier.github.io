<template>
  <div>
    <h2>About</h2>
    <p>
      I am a machine learning (ML) scientist based in Zurich, Switzerland. I
    ...
    <p>
      ...
      causal inference (CI) due to its relationship to metaphysics, epistemology
    ...
    <p>
      ...
      have begun developing in Clojure and Julia. For ML, my tech stack consists
      of Stan, Jax, NumPyro and TensorFlow (Probability). I am an advocate of
